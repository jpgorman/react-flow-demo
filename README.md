...
- There aren't any connections with inputs/ouputs for the Any nodeType. I've tested thiss by hard coding some of the generated nodes. The specified nodes and their inputs/outputs don't mention the Any nodeType so I've not included that type here, but I have accounted for it in the validation.
